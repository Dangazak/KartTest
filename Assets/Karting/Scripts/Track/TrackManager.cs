...
namespace KartGame.Track
{
    ...
    public class TrackManager : MonoBehaviour
    {
		...
		//referencia al texto de nuevo record
        ...
        public void StopRace ()
        {
			...
			//Activa el menu de Game Over al terminar la carrera
            ...
            if (checkpoint.isStartFinishLine)
            {
                ...
                if (racerCurrentLap > 0)
                {
					...
					if (m_HistoricalBestLap.time > lapTime){
						...
						//Al conseguir el mejor tiempo del vuelta guardarlo localmente
						GameControl.control.bestTime = lapTime;
